/* 
* This implementation is the serial version of neural network classification.
* Using GPROF, we can see that the function Forward() and Backward() takes the most time.
* The goal is to optimize those functions using CUDA.
*/
